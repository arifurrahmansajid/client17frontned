    ...
    <div className="flex flex-col bg-[#F5F3FF] min-h-full pb-6">
      ...
      <div className="-mt-16 px-4 space-y-4 relative z-20">
        ...
        <div className="flex gap-3">
          <div className="flex-1 bg-gradient-to-br from-indigo-600 via-violet-600 to-purple-600 rounded-3xl p-5 shadow-lg shadow-violet-500/25 text-white relative overflow-hidden">
        ...
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-violet-100">
          ...
          <div className="space-y-3">
            {[
              { level: 1, rate: 20, color: "text-indigo-600", bg: "bg-indigo-50", text: "Direct referrals (Level 1)" },
              { level: 2, rate: 3, color: "text-violet-600", bg: "bg-violet-50", text: "Secondary referrals (Level 2)" },
              { level: 3, rate: 2, color: "text-purple-600", bg: "bg-purple-50", text: "Tertiary referrals (Level 3)" }
            ].map((tier) => (
              <div key={tier.level} className="flex items-center gap-4 bg-violet-50/60 p-3.5 rounded-2xl border border-violet-100/50">
                <div className={`w-14 h-14 ${tier.bg} shrink-0 flex flex-col items-center justify-center rounded-xl shadow-inner border border-white/60`}>
